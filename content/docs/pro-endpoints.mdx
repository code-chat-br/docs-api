...
A classificacao e apenas documental no runtime atual e nao altera respostas nem adiciona `402`. Consulte [Chamadas](/docs/calls) para arquitetura, flags globais, configuracao por instancia, comportamento multi-device, gravacao e eventos.
