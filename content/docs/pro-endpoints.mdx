...
A classificação é apenas documental no runtime atual e não altera respostas nem adiciona `402`. Consulte [Envio em lote](/docs/message-batches) para arquitetura, estados, payloads, recovery e webhooks.
