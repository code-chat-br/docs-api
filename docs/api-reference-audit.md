...
| `GET` | `/call/{instanceName}/active` | `getActiveCalls` | Pro |
...
| `GET` | `/call/{instanceName}/{callId}/recordings/audio/download` | `downloadUnifiedAudioCallRecording` | Pro |
| `GET` | `/call/{instanceName}/{callId}/recordings/video/incoming/download` | `downloadUnifiedIncomingVideoCallRecording` | Pro |
| `GET` | `/call/{instanceName}/{callId}/recordings/video/outgoing/download` | `downloadUnifiedOutgoingVideoCallRecording` | Pro |
| `GET` | `/call/{instanceName}/{callId}/recordings/{recordingId}/download` | `downloadCallRecording` | Pro |
| `GET` | `/call/{instanceName}/capabilities` | `getCallProviderCapabilities` | Pro |
| `POST` | `/call/{instanceName}/groups/{groupId}` | `startExistingGroupCall` | Pro |
| `POST` | `/call/{instanceName}/group` | `startAdHocGroupCall` | Pro |
| `GET` | `/call/{instanceName}/links` | `listCallLinks` | Pro |
| `POST` | `/call/{instanceName}/links` | `createCallLink` | Pro |
| `POST` | `/call/{instanceName}/links/preview` | `previewCallLink` | Pro |
| `GET` | `/call/{instanceName}/links/{linkId}` | `getCallLink` | Pro |
| `DELETE` | `/call/{instanceName}/links/{linkId}` | `softDeleteCallLink` | Pro |
| `POST` | `/call/{instanceName}/links/{linkId}/join` | `joinCallLink` | Pro |
| `POST` | `/call/{instanceName}/links/{linkId}/leave` | `leaveCallLink` | Pro |
| `GET` | `/call/{instanceName}/{callId}/participants` | `listCallParticipants` | Pro |
| `POST` | `/call/{instanceName}/{callId}/participants` | `addCallParticipants` | Pro |
| `POST` | `/call/{instanceName}/{callId}/participants/{participantId}/ring` | `reringCallParticipant` | Pro |
| `DELETE` | `/call/{instanceName}/{callId}/participants/{participantId}` | `removeCallParticipant` | Pro |
| `GET` | `/call/{instanceName}/{callId}/waiting` | `listWaitingParticipants` | Pro |
| `POST` | `/call/{instanceName}/{callId}/waiting/{participantId}/admit` | `admitWaitingParticipant` | Pro |
| `POST` | `/call/{instanceName}/{callId}/waiting/{participantId}/reject` | `rejectWaitingParticipant` | Pro |
| `POST` | `/call/{instanceName}/{callId}/waiting/admit-all` | `admitAllWaitingParticipants` | Pro |
| `POST` | `/call/{instanceName}/{callId}/waiting/reject-all` | `rejectAllWaitingParticipants` | Pro |
| `POST` | `/call/{instanceName}/{callId}/hand` | `raiseCallHand` | Pro |
| `DELETE` | `/call/{instanceName}/{callId}/hand` | `lowerCallHand` | Pro |
| `GET` | `/call/{instanceName}/{callId}/screen-share` | `getCallScreenShare` | Pro |
| `POST` | `/call/{instanceName}/{callId}/screen-share/start` | `startCallScreenShare` | Pro |
| `POST` | `/call/{instanceName}/{callId}/screen-share/stop` | `stopCallScreenShare` | Pro |
| `GET` | `/call/{instanceName}/schedules` | `listScheduledCalls` | Pro |
| `POST` | `/call/{instanceName}/schedules` | `createScheduledCall` | Pro |
| `GET` | `/call/{instanceName}/schedules/{scheduleId}` | `getScheduledCall` | Pro |
| `PATCH` | `/call/{instanceName}/schedules/{scheduleId}` | `updateScheduledCall` | Pro |
| `DELETE` | `/call/{instanceName}/schedules/{scheduleId}` | `cancelScheduledCall` | Pro |
