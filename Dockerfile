...
ARG NEXT_PUBLIC_GITHUB_URL=https://github.com/code-chat-br/whatsapp-api-go
ARG NEXT_PUBLIC_DOCS_GITHUB_URL=https://github.com/code-chat-br/docs-api
ARG NEXT_PUBLIC_SUPPORT_URL=https://github.com/code-chat-br/whatsapp-api-go/issues
...
ENV NEXT_PUBLIC_DOCS_GITHUB_URL=$NEXT_PUBLIC_DOCS_GITHUB_URL
