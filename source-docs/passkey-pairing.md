...
| --- | --- | --- |
| `POST` | `/instance/:instance/connect/passkey/challenge` | Retorna ou cria um challenge WebAuthn para a sessão de pareamento ativa. |
| `POST` | `/instance/:instance/connect/passkey/assertion` | Recebe a assertion WebAuthn e envia para o WhatsApp. |
...
```http
POST /instance/codechat/connect/passkey/challenge
...
```http
POST /instance/codechat/connect/passkey/assertion
Authorization: Bearer <instance-token>
...
Os aliases `POST /instance/connect/:instanceName/passkey/challenge` e `POST /instance/connect/:instanceName/passkey/assertion` permanecem registrados, usam os mesmos handlers e estão marcados como deprecated no OpenAPI porque possuem substitutos atuais.
