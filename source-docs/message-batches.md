...
Filtros de lotes são enviados no body de `POST /message/batches/list`: `status`, `instanceName`, `createdFrom`, `createdTo`, `query`, `limit`, `nextCursor`, `previousCursor`. Envie `{}` para usar os padrões. Datas usam RFC 3339.
