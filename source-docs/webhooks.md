...
Esses eventos sao enviados uma unica vez ao `WEBHOOK_GLOBAL_URL`; nao sao repetidos por instancia. A linha de outbox e criada no mesmo commit da alteracao do lote/item, e a chamada HTTP acontece depois da transacao.
